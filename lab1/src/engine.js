...
function GAMES202Main() {
	...
	let lightPos_2 = [80,80,80];
	let focalPoint_2 = [0,0,0];
	let lightUp_2 = [0,1,0];
	const directionLight_2 = new DirectionalLight(5000,[1,1,1],lightPos_2,focalPoint_2,lightUp_2,true,renderer.gl);
